...
public class MainActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            ...
            idTopic = savedInstanceState.getInt(ID_TOPIC, R.id.mrsh0);
        } else {
            ...
            idTopic = sPref.getInt(ID_TOPIC, R.id.mrsh0);
        }
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        // Блок выбора тем
        if (id == R.id.mrsh0) {
            webView.loadUrl(resourceDir + "MRSH/mrsh0.htm");
        } else if (id == R.id.sony0) {
            webView.loadUrl(resourceDir + "SONY/sony0.htm");
        } else if (id == R.id.apple0) {
            webView.loadUrl(resourceDir + "APPLE/apple0.htm");
        } else if (id == R.id.play) {
                webView.loadUrl(resourceDir + "PLAY/play.htm");

            // Блок внешних переходов
        } else {
            if (id == R.id.nav_view1) { // Переход на внешнюю html-ссылку и внешний браузер
                openLinkExternally(getString(R.string.marshall));
            }
            if (id == R.id.nav_view2) { // Переход на внешнюю html-ссылку и внешний браузер
                openLinkExternally(getString(R.string.sony));
            }
            if (id == R.id.nav_view3) { // Переход на внешнюю html-ссылку и внешний браузер
                openLinkExternally(getString(R.string.apple));
            }
